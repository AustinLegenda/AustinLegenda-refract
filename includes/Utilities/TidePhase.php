    ...
    public function stateForStation(PDO $pdo, string $stationId, string $nowUtc, int $slackMin = 30): array
{
    ...
    $prev = \Legenda\NormalSurf\Repositories\TideRepo::getPrevHL($pdo, $stationId, $nowUtc);
    $nextList = \Legenda\NormalSurf\Repositories\TideRepo::getNextHL($pdo, $stationId, $nowUtc, 3);
    $next = null;
